...
<pre class="pre-algo-1">
1. Натисніть "OK".
2. Відобразиться діалог підтвердження з інформацією про шлюз безпечного обміну. Якщо ви не бачите найменування організації у полі «Organization (O)» - це ознчає, до ваша організації ще не зареєстрована. Зверніться до Адміністратора СЕВДЕІР для уточнення. Якщо всі поля заповнені - натисніть "OK".
3. Збережіть файл з розширенням .pem на своєму комп’ютері.
</pre>
