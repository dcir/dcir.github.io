...
- [Інсталяція тестового шлюзу безпечного обміну](#інсталяція-тестового-шлюзу-безпечного-обміну)
  ...
  - [Рисунок 1 {#trembita-test-0}](#рисунок-1-trembita-test-0)
...
Для підключення до **тестового середовища** обов’язковим компонентом Учасника є шлюз безпечного обміну (компонент, позначений як «VM Шлюз безпечного обміну» на [рисунку 1](#trembita-test-0). Це віртуальна машина, що повинна мати вихід до мережі Інтернет, а також приймати вхідні підключення з мережі Інтернет. 
